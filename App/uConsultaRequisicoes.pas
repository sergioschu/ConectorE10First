...
procedure TFrmConsultaRequisicoes.AtualizarPedidos;
const
...
procedure TFrmConsultaRequisicoes.AtualizarTransportadora;
const
  xlCellTypeLastCell = $0000000B;
type
  TLISTATRANSP = record
...
procedure TFrmConsultaRequisicoes.btAtualizarPedidosClick(Sender: TObject);
begin
...
procedure TFrmConsultaRequisicoes.btAtualizarTransportadoraClick(Sender: TObject);
begin
...
procedure TFrmConsultaRequisicoes.btExportarClick(Sender: TObject);
Var
  Arq : string;
begin
...
procedure TFrmConsultaRequisicoes.btReenviarClick(Sender: TObject);
begin
...
procedure TFrmConsultaRequisicoes.CarregaDados;
Var
  FWC : TFWConnection;
  SQL : TFDQuery;
  I   : Integer;
...
procedure TFrmConsultaRequisicoes.csPedidosFilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
var
  I : Integer;
begin
...
procedure TFrmConsultaRequisicoes.gdPedidosCellClick(Column: TColumn);
begin
...
procedure TFrmConsultaRequisicoes.gdPedidosDrawColumnCell(Sender: TObject;
...
procedure TFrmConsultaRequisicoes.gdPedidosTitleClick(Column: TColumn);
begin
...
procedure TFrmConsultaRequisicoes.MarcarDesmarcarTodos;
Var
  Aux : Boolean;
begin
...
procedure TFrmConsultaRequisicoes.Reenviar;
var
  FWC : TFWConnection;
  P   : TPEDIDO;
begin
