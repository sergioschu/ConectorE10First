object frmCadastroTransportadora: TfrmCadastroTransportadora
  ...
  object dsTransportadoras: TDataSource
    DataSet = csTransportadoras
    Left = 312
    Top = 208
  end
  object csTransportadoras: TClientDataSet
    Aggregates = <>
    Params = <>
    OnFilterRecord = csTransportadorasFilterRecord
    Left = 416
    Top = 208
    object csTransportadorasID: TIntegerField
      FieldName = 'ID'
    end
    object csTransportadorasCNPJ: TStringField
      DisplayLabel = 'Cnpj'
      FieldName = 'CNPJ'
      Size = 19
    end
    object csTransportadorasNOME: TStringField
      DisplayLabel = 'Nome'
      FieldName = 'NOME'
      Size = 100
    end
